...
VERSION_AUTHORIZATION=0.11.3
VERSION_AWS_S3=2.5.2
VERSION_DICOM_WEB=1.23
VERSION_GDCM=1.8
VERSION_INDEXER=1.1
VERSION_MYSQL=5.0
VERSION_NEURO=1.1
...
VERSION_STL=1.4
VERSION_STONE_WEB_VIEWER=3.0
VERSION_TCIA=1.3
VERSION_TRANSFERS=1.7
VERSION_VOLVIEW=1.3
VERSION_WEB_VIEWER=2.10
VERSION_WSI=3.3
VERSION_EDUCATION=1.1
